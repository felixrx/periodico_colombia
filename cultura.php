...
<body>
	...
	<section class="dep-secc1">
		<div class="caja1">
			<H1> <font face="Trebuchet MS">CULTURA</p> </font> </H1>
...
$sql = "SELECT * FROM noticias where status='activa' and categoria='Cultura' order by id DESC LIMIT 4";
	...
	<div class="seccion-img sec-1">
		...
		<h2><?php echo "".$titulo =$fila['titulo']; ?></h2>
