...
<body>
	...
	<section class="dep-secc1">
		<div class="caja1">
			<H1> <font face="Trebuchet MS">DEPORTES</p> </font> </H1>
		...
		<section class="cont-imagenes">

<?php
include('conexion/conexion.php');

$sql = "SELECT * FROM noticias where status='activa' and categoria='Deporte' order by id DESC LIMIT 4";
	...
	<div class="seccion-img sec-1">
		<div class="img "> <img style="width: 100%; height: 100%; border-radius: 10px 10px 0px 0px;" src="<?php echo "". $imagen =$fila['imagen'] ; ?>" alt=""></div>
		...
		<h2 ><?php echo "".$titulo =$fila['titulo']; ?><br></h2>
		<h3> <?php echo "".$subtitulo =$fila['subtitulo'];; ?> </h3>
